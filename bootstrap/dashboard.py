            ...
            <div class="dl-after" id="gen-howto" style="display:none">
              <div class="howto">
                ...
                <div class="tabpane" data-pane="win">
                  ...
                  <span class="chip" data-copy-text="Connection > SSH > Auth > Credentials" role="button" tabindex="0">Connection &rsaquo; SSH &rsaquo; Auth &rsaquo; Credentials</span>
                  <svg viewBox="0 0 460 200" width="100%" style="display:block;margin:9px 0 2px;border-radius:6px" role="img" aria-label="PuTTY Configuration window on the Connection, SSH, Auth, Credentials page, with the private key file field set to the downloaded id_ed25519.ppk"><rect x="4" y="4" width="452" height="192" rx="6" fill="#f0f0f0" stroke="#8f8f8f"/><path d="M4 10a6 6 0 0 1 6-6h440a6 6 0 0 1 6 6v15H4z" fill="#3a6ea5"/><text x="14" y="20" font-family="system-ui,sans-serif" font-size="11" fill="#fff">PuTTY Configuration</text><text x="446" y="20" font-family="system-ui,sans-serif" font-size="11" fill="#d6e2f0" text-anchor="end">&#8211;  &#9633;  &#10005;</text><rect x="14" y="36" width="134" height="150" fill="#fff" stroke="#8f8f8f"/><text font-family="system-ui,sans-serif" font-size="11" fill="#222"><tspan x="22" y="54">Session</tspan><tspan x="22" y="74">Connection</tspan><tspan x="34" y="94">SSH</tspan><tspan x="46" y="114">Auth</tspan></text><rect x="20" y="122" width="122" height="18" rx="2" fill="#cce4ff"/><text x="56" y="135" font-family="system-ui,sans-serif" font-size="11" fill="#08306b">Credentials</text><text x="162" y="54" font-family="system-ui,sans-serif" font-size="10.5" fill="#333">Private key file for authentication:</text><rect x="156" y="62" width="290" height="34" rx="5" fill="none" stroke="#e8750a" stroke-width="2"/><rect x="162" y="68" width="216" height="22" fill="#fff" stroke="#8f8f8f"/><text x="168" y="83" font-family="ui-monospace,Consolas,monospace" font-size="9" fill="#111">C:\Users\you\.ssh\id_ed25519.ppk</text><rect x="382" y="68" width="58" height="22" fill="#e9e9e9" stroke="#8f8f8f"/><text x="411" y="83" font-family="system-ui,sans-serif" font-size="10" fill="#111" text-anchor="middle">Browse&#8230;</text><circle cx="166" cy="116" r="8" fill="#e8750a"/><text x="166" y="120" font-family="system-ui,sans-serif" font-size="10" fill="#fff" text-anchor="middle">1</text><text x="180" y="120" font-family="system-ui,sans-serif" font-size="11" fill="#9a4a06">Browse here &#8594; the .ppk you downloaded</text><rect x="328" y="156" width="50" height="22" fill="#e9e9e9" stroke="#8f8f8f"/><text x="353" y="171" font-family="system-ui,sans-serif" font-size="10" fill="#111" text-anchor="middle">Open</text><rect x="382" y="156" width="58" height="22" fill="#e9e9e9" stroke="#8f8f8f"/><text x="411" y="171" font-family="system-ui,sans-serif" font-size="10" fill="#111" text-anchor="middle">Cancel</text></svg>
